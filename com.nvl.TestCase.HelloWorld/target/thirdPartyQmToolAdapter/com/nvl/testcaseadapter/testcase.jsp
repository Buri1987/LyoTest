...
<%@page import="com.nvl.TestCaseAdapter.resources.NvlQmDomainConstants"%>
...
<div class="container">
    <div class="page-header">
        ...
        <%
        URI shapeUri = UriBuilder.fromUri(OSLC4JUtils.getServletURI()).path(OslcConstants.PATH_RESOURCE_SHAPES).path(NvlQmDomainConstants.TESTCASE_PATH).build();
