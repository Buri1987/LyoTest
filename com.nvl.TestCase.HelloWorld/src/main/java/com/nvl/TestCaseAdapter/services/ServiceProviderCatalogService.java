...
public class ServiceProviderCatalogService
{
    ...
    public ServiceProviderCatalog getServiceProviderCatalog(@PathParam("serviceProviderCatalogId") final String serviceProviderCatalogId)
    {
        ...
        if (catalog != null) {
            httpServletResponse.addHeader(OSLCServerTestCasesThirdPartyToolConstants.HDR_OSLC_VERSION,"2.0");
            return catalog;
        }
    ...
    public void getHtmlServiceProvider(@PathParam("someId") final String someId)
    {
        ...
        if (catalog !=null )
        {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/nvl/testcaseadapter/serviceprovidercatalog.jsp");
            try {
