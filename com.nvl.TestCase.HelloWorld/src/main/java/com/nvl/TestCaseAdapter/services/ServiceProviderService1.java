...
public class ServiceProviderService1
{
    ...
    public void createTestCaseFromDialog(MultivaluedMap<String, String> formParams
        ...
        paramValues = formParams.get("createdby");
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setCreatedby(paramValues.get(0));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }

        }
        paramValues = formParams.get("owner");
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setOwner(paramValues.get(0));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }
        ...
        paramValues = formParams.get("rdfObject");
        if (paramValues != null) {
                for(int i=0; i<paramValues.size(); i++) {
                    aResource.addRdfObject(new Link(new URI(paramValues.get(i))));
                }
        }
