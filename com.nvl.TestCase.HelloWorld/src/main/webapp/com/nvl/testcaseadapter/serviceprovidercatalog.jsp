...
<html lang="en">
  <head>
    ...
    <title>Service Provider Catalog - OSLC Server TestCases Third Party Tool OSLC Adapter</title>
  ...
  <div class="container">
    <div class="page-header">
      <h1>OSLC Server TestCases Third Party Tool Service Provider Catalogue</h1>
    </div>
    ...
    <% if (catalog.getServiceProviders().length == 0) {%>
        <div class="alert alert-primary" role="alert">
            ...
            <p>
                ...
                in the class <code>com.nvl.TestCaseAdapter.OSLCServerTestCasesThirdPartyToolManager</code>, to return the expected set of Service Provider resources.
            </p>
        </div>
    <% } %>
