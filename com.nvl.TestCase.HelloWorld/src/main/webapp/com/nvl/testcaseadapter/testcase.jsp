...
<%@page import="com.nvl.TestCaseAdapter.resources.Oslc_qmDomainConstants"%>
...
<div class="container">
    <div class="page-header">
        ...
        <div>
          ...
          <dl class="row">
            <% method = TestCase.class.getMethod("getCreatedby"); %>
            <dt  class="col-sm-2 text-right"><a href="<%=method.getAnnotation(OslcPropertyDefinition.class).value() %>"><%=method.getAnnotation(OslcName.class).value()%></a></dt>
            <dd class="col-sm-9">
            <%
            if (aTestCase.getCreatedby() == null) {
                out.write("<em>null</em>");
            }
            else {
                out.write(aTestCase.getCreatedby().toString());
            }
            %>
          ...
          <dl class="row">
            <% method = TestCase.class.getMethod("getOwner"); %>
            <dt  class="col-sm-2 text-right"><a href="<%=method.getAnnotation(OslcPropertyDefinition.class).value() %>"><%=method.getAnnotation(OslcName.class).value()%></a></dt>
            <dd class="col-sm-9">
            <%
            if (aTestCase.getOwner() == null) {
                out.write("<em>null</em>");
            }
            else {
                out.write(aTestCase.getOwner().toString());
            }
            %>
          ...
          <dl class="row">
            <% method = TestCase.class.getMethod("getRdfObject"); %>
            <dt  class="col-sm-2 text-right"><a href="<%=method.getAnnotation(OslcPropertyDefinition.class).value() %>"><%=method.getAnnotation(OslcName.class).value()%></a></dt>
            <dd class="col-sm-9">
            <ul>
            <%
            for(Link next : aTestCase.getRdfObject()) {
