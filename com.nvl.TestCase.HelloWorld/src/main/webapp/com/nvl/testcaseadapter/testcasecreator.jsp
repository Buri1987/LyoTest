  ...
  <body style="padding: 10px;">
    ...
    <form id="Create" method="POST" class="enter_bug_form">
        <table style="clear: both;">
          ...
          <tr>
            <td>
            <label for="dokumentenNummer">dokumentenNummer: </LABEL>
            <%
            out.write("<input name=\"dokumentenNummer\" type=\"text\" style=\"width: 400px\" id=\"dokumentenNummer\" >");
            %>
            </td>
          </tr>
          <tr>
            <td>
            <label for="testLevel">testLevel: </LABEL>
            <%
            out.write("<input name=\"testLevel\" type=\"text\" style=\"width: 400px\" id=\"testLevel\" >");
            %>
            </td>
          </tr>
          <tr>
            ...
            <%
            out.write("<input name=\"createdby\" type=\"text\" style=\"width: 400px\" id=\"createdby\" >");
            %>
            </td>
          </tr>
          <tr>
            ...
            <%
            out.write("<input name=\"owner\" type=\"text\" style=\"width: 400px\" id=\"owner\" >");
            %>
            </td>
          </tr>
          <tr>
