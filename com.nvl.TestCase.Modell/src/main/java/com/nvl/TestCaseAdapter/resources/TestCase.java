...
// End of user code
@OslcNamespace(RdfDomainConstants.TESTCASE_NAMESPACE)
@OslcName(RdfDomainConstants.TESTCASE_LOCALNAME)
@OslcResourceShape(title = "Description", description = "Description (Test Case) defines the criteria which determine whether a system exhibits the correct behavior under a specific set of circumstances. ", describes = RdfDomainConstants.TESTCASE_TYPE)
    ...
    implements ITestCase
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        RdfDomainConstants.TESTCASE_PATH,
        TestCase.class);
    }
